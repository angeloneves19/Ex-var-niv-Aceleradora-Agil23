...
const objeto = () => {
  pkm.push({
    ...
    place1: remocao[5].slice(2, 10),
    place2: remocao[7].slice(1, 7),
    place3: remocao[6]
  })
console.log(`
...
Attacks:
    - ${transforma(pkm[0].atacks1)},
    - ${transforma(pkm[0].atacks2.trim())}
    - ${transforma(pkm[0].atacks3)}

Places:
    - ${placeMinusculas(pkm[0].place1)}
    - ${placeMinusculas(pkm[0].place2)}
    - ${placeMinusculas(pkm[0].place3)}
    `)
}
objeto()
